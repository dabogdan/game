...
//        return;
	...
	if(isLeft)
	{
		if(gameChar_x > width * 0.2 && isPlummeting == false)
		{
			gameChar_x -= 5;
		}
		else
	...
	if(isRight)
	{
		if(gameChar_x < width * 0.8 && isPlummeting == false)
		{
			gameChar_x  += 5;
		}
		else
...
function drawTrees () 
{
    ...
    //  draw the tree
        ...
        fill(21, 87, 47); //green
        triangle(trees_x[i]-25,402,trees_x[i]+5,350,trees_x[i]-35+70,402); //lower branch
        triangle(trees_x[i]-25,402-30,trees_x[i]+5,350-30,trees_x[i]-35+70,402-30); //middle branch
        triangle(trees_x[i]-25,402-30-30,trees_x[i]+5,350-30-30,trees_x[i]-35+70,402-30-30);//higher branch
    }
}
...
{    
    //draw the canyon
    fill(102,102,153);
    rect(t_canyon.x_pos, 432, t_canyon.width, 144);//borders of the canyon
    fill(100,155,255);
    rect(t_canyon.x_pos + 20, 550, t_canyon.width - 40, 26);//water
    fill(255,215,0);
    rect(t_canyon.x_pos + 20, 432, t_canyon.width - 40, 118);//yellow space for the character to fall within
